...
public static class TransactionMapping
{
    ...
    public static ProductInCart MapToDomain(this ProductInCartModel model)
        => ProductInCart.Create(model.ProductModelInCart.ProductId.Value,
            model.Count,
            model.ProductModelInCart.Price);
    public static List<ProductInCart> MapToDomainList(
    ...
    public static TransactionModel MapToModel(this Transaction transaction) =>
        new TransactionModel
        {
            ...
            NumberOfCoupons = transaction.Coupons.Count
        };
    ...
    public static Messages.V1.TypeOfDiscountDto MapToDtoMessages(this TypeOfDiscountCouponModel model) =>
        model switch
        {
            TypeOfDiscountCouponModel.Percentage => Messages.V1.TypeOfDiscountDto.Percentage,
            TypeOfDiscountCouponModel.Total => Messages.V1.TypeOfDiscountDto.Total,
            _ => throw new NotImplementedException(),
        };

    public static Messages.V1.AddTransactionToCouponsDto MapToServiceBus(this CouponModel model) =>
    new Messages.V1.AddTransactionToCouponsDto
    {
    ...
    public static List<Messages.V1.AddTransactionToCouponsDto> MapToServiceBusList(
        this List<CouponModel> modelList) =>
        modelList.Select(o => o.MapToServiceBus()).ToList();

    public static Messages.V1.AddProductInCartDto MapToServiceBus(this ProductInCartModel model) =>
    ...
    public static List<Messages.V1.AddProductInCartDto> MapToServiceBusList(
